...
const adoptedDolls: AdoptedDoll[] = [
  ...
  { name: "Lenora", image: lenoraImg, collection: "Spirit" },
  { name: "Hearth", image: hearthImg, collection: "Spirit" },
  { name: "Willow", image: willowImg, collection: "Spirit" },
  ...
  { name: "Ellie", image: ellieImg, collection: "Random Acts of Love" },
  { name: "Scott", image: scottImg, collection: "Random Acts of Love" },
];
