...
const allDolls: Doll[] = [
  ...
  { name: "Pocket Spirit Dolls", image: pocketSpiritsImg, story: "Tiny talismans of intention — each ~2 inch handmade folk art doll comes with a fabric pouch, chakra worry stone, and handwritten inspirational message. Choose your one-of-a-kind spirit (A–F) on Etsy.", squareUrl: "https://littlepandaacts.etsy.com/listing/4470017968/pocket-spirit-dolls-handmade-folk-art", collection: "spirit", price: "$35" }
];
