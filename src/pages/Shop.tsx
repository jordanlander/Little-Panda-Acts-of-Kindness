...
const allDolls: Doll[] = [
  { name: "Ellie", image: ellieImg, story: "Soft and snuggly, Ellie loves afternoon naps and warm hugs.", squareUrl: "https://square.link/u/XmB4Rw0x", collection: "random" },
  { name: "Bert", image: bertImg, story: "Bert is curious and kind, always ready for a new adventure.", squareUrl: "https://square.link/u/dc1hOWOI", collection: "random" },
  { name: "Edith", image: edithImg, story: "Gentle Edith enjoys quiet moments and bedtime stories.", squareUrl: "https://square.link/u/gKqsfaUb", collection: "random" },
  { name: "Eddie", image: eddieImg, story: "Eddie is playful and spirited, bringing joy wherever he goes.", squareUrl: "https://square.link/u/eZ7eqzV9", collection: "random" },
  { name: "Ginger", image: gingerImg, story: "Ginger is sweet and thoughtful, a loyal companion through and through.", squareUrl: "https://square.link/u/d8DI7QxK", collection: "random" },
  { name: "Steve", image: steveImg, story: "Steve loves comfort and calm, perfect for cozy evenings.", squareUrl: "https://square.link/u/sLM2YmE3", collection: "random" },
  { name: "Earl", image: earlImg, story: "Earl is wise and warm-hearted, a true friend to all.", squareUrl: "https://square.link/u/QwUBTugj", collection: "random" },
  { name: "Hugh", image: hughImg, story: "Hugh is gentle and caring, always ready to listen.", squareUrl: "https://square.link/u/4yciYxat", collection: "random" },
  { name: "Scott", image: scottImg, story: "Scott is cheerful and bright, bringing smiles to every day.", squareUrl: "https://square.link/u/5innkTKy", collection: "random" },
  { name: "Charlie", image: charlieImg, story: "An artsy soul with a bold personality and unique flair.", squareUrl: "https://square.link/u/rHLp0yxR", collection: "love" },
  { name: "Agnes", image: agnesImg, story: "Agnes is creative and expressive, a true work of art.", squareUrl: "https://square.link/u/csUVf69U", collection: "love" },
  { name: "Jane", image: janeImg, story: "Jane is elegant and sophisticated, made for display.", squareUrl: "https://square.link/u/u3hmJuKm", collection: "love" },
  { name: "Tim", image: timImg, story: "Tim is quirky and charming, full of character.", squareUrl: "https://square.link/u/k865p4uB", collection: "love" },
  { name: "Lee", image: leeImg, story: "Lee is modern and stylish, a statement piece.", squareUrl: "https://square.link/u/E6mQx6CF", collection: "love" },
  { name: "Peggy", image: peggyImg, story: "Peggy is vintage-inspired and whimsical.", squareUrl: "https://square.link/u/lC5jDu9C", collection: "love" },
  { name: "James", image: jamesImg, story: "James is distinguished and refined.", squareUrl: "https://square.link/u/LS5qPbd0", collection: "love" },
  { name: "Uli", image: uliImg, story: "Uli is artistic and unconventional.", squareUrl: "https://square.link/u/Trpk94aJ", collection: "love" },
  { name: "Sue", image: sueImg, story: "Sue is graceful and poised.", squareUrl: "https://square.link/u/59A2D1PH", collection: "love" },
  { name: "Darrell", image: darrellImg, story: "Darrell is bold and confident.", squareUrl: "https://square.link/u/Tp9qsTw1", collection: "love" },
  { name: "Otis", image: otisImg, story: "Otis is fun-loving and spirited.", squareUrl: "https://square.link/u/58f0it0Y", collection: "love" },
  { name: "Henry", image: henryImg, story: "Henry is classic and timeless.", squareUrl: "https://square.link/u/jq93yQBT", collection: "love" },
  { name: "Stan", image: stanImg, story: "Stan is unique and memorable.", squareUrl: "https://square.link/u/MBf8Gu2u", collection: "love" },
  { name: "Mary", image: maryImg, story: "Mary is sweet and endearing.", squareUrl: "https://square.link/u/ODPKUpkw", collection: "love" },
  { name: "Baily", image: bailyImg, story: "Baily is playful and expressive.", squareUrl: "https://square.link/u/OJnud01G", collection: "love" },
