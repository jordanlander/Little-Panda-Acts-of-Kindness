...
const allDolls: Doll[] = [
  ...
  { name: "Peggy", image: peggyImg, story: "Peggy is vintage-inspired and whimsical.", squareUrl: "https://little-panda-acts-of-kindness.square.site/product/peggy-love-happens-collection/S3OSQEGQHMDKZVR5FRX5ZTTP", collection: "love", price: "$95", sold: true },
  ...
  { name: "Sue", image: sueImg, story: "Sue is graceful and poised.", squareUrl: "https://little-panda-acts-of-kindness.square.site/product/sue-love-happens-collection/KB5QRXAV7VGST5BWWIY6UHZ3", collection: "love", price: "$95", sold: true },
  ...
  { name: "Otis", image: otisImg, story: "Otis is fun-loving and spirited.", squareUrl: "https://little-panda-acts-of-kindness.square.site/product/otis-love-happens-collection/WM6RUEJWJH4IRFEZLHDWUQEE", collection: "love", price: "$95", sold: true },
  ...
  { name: "Stan", image: stanImg, story: "Stan is unique and memorable.", squareUrl: "https://little-panda-acts-of-kindness.square.site/product/stan-love-happens-collection/N236IRITL3D2WVGAQEFCWDQ4", collection: "love", price: "$95", sold: true },
  ...
  { name: "Raven", image: ravenImg, story: "Keeper of ancient wisdom and midnight magic.", squareUrl: "https://littlepandaacts.etsy.com/listing/4424486931/raven-spirit-doll-collection-handmade", collection: "spirit", price: "$65" },
